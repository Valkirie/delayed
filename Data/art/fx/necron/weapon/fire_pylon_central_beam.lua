fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/NECRON/BEAMS/PYLON_CENTRAL_BEAM_1.TGA",
				},
				property_04 =  
				{
					name = "Offset",
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/NECRON/BEAMS/PYLON_CENTRAL_BEAM_2.TGA",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>titan_beam_2>muzzle_lascannon_beam",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>ring_blast_spray_combo>titan_muzzle_ring_2",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/NECRON/GLOW_RINGS/PYLON_GREEN_MUZZLE_RING_1.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>zzap_gun_combo>titan_flash_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "TEXTURES_NEW/NECRON/ENV_FLASH_BIG_GREEN.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
