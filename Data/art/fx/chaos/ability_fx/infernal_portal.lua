fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_FIRE_PUFF6_BLUE.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>shrine_mouthfire>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/HVY_FLAMER_GLOW_PURPLE.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>shrine_mouthfire>default_beam",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>shrine_mouthfire>__fxtool_private_copy>env_steam_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_FIRE_PUFF_BLUE.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
