fxtypes =  
{
	...
	{
		effect = "root>chaos_teleport>dark_ring_combo2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>chaos_teleport>dark_ring_combo2>dark_outter_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>chaos_teleport>deep_strikelightning_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>chaos_teleport>deep_strikelightning_combo>unit_melee_hammer_lightning_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>chaos_teleport>deep_strikelightning_combo>unit_melee_hammer_lightning_spray>unit_melee_powersword_lightning_hit_beam",
		fx =  
		{
			properties =  
			{
